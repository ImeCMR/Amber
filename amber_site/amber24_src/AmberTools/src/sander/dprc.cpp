...
private:
  ...
  std::tr1::shared_ptr<deepmd::hpp::DeepPot> nnp_inter;
  std::tr1::shared_ptr<deepmd::hpp::DeepPotModelDevi> nnp_inter_devi;
...
std::tr1::shared_ptr< glbmleval > glbmlinter;
std::tr1::shared_ptr< glbmleval > glbmlintra;
