...
#ifdef nvCUDA
   integer               :: msrf_cu       ! for passing arccrd to CUDA - R.Q.
   integer               :: mtri_cu       ! for passing arccrd to CUDA - R.Q.
#endif
...
#  include "pb_constants.h"
   ...
   do iatm = 1, natom
      ...
      !       extensions to XC/2C/3C/C8 added for newer ff
      if     ( isymbl(iatm)(1:2) == 'CT' .or. &
               isymbl(iatm)(1:2) == 'XC' .or. &
...
subroutine sa_arc( verbose,pbprint,pqropt,natom,atmfirst,atmlast )
   ...
   msrf_cu = msrf
   mtri_cu = mtri
   !write(6, *) ' 1 msrf_cu, msrf, mtri_cu, mtri', msrf_cu, msrf, mtri_cu, mtri
#endif
   ...
   msrf_cu = msrf
   mtri_cu = mtri
   !write(6, *) ' 2 msrf_cu, msrf, mtri_cu, mtri', msrf_cu, msrf, mtri_cu, mtri
#endif
