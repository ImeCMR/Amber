...
#  include "pb_md.h"
   ...
   if ( ifcap == 0 .or. (ifcap >= 3 .and. ifcap <= 5) ) then
      ...
      if ( radiopt == 0 ) then
         ...
         radi = rin ! for pb
         ! to fix the bug causing discrepancy in dispersion energy between radiopt == 0/1
         !mdsig = rin ! for np
...
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
!+ Setup parameter tables for machine learned ses
subroutine pb_mlses
