...
module array_util
  ...
  interface array_index
     module procedure index_c, index_i, index_r64!, index_l
  end interface
contains
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
!!!'back' then returns the last element.
!!!IN:
!!!   a     : real(kind=real64) array
!!!   value : real(kind=real64) value
!!!   back  : (optional) search backwards
!!!OUT:
!!!    Index of the element matching the value, -1 if it does not exist
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  function index_r64(a,value,back) result(i)
    implicit none
    real(kind=real64), intent(in) :: a(:), value
    logical, optional, intent(in) :: back
    integer :: i, start, finish, incr
    start = lbound(a,1)
    finish = ubound(a,1)
