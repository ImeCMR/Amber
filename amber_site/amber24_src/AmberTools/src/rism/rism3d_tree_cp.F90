...
!
      ...
      INTEGER(kind=int64),INTENT(IN) :: numparsS,numparsT
      TYPE(tnode),POINTER :: p  
...
!
      ...
      INTEGER(kind=int64),INTENT(IN) :: arrdim
      TYPE(tnode),POINTER :: p      
...
! local variables
        ...
        INTEGER :: i,j,k,k1,k2,k3,kk,porder,porder1,nj,nk,xyind
...
!
      ...
      INTEGER(kind=int64),INTENT(IN) :: numpars
      TYPE(tnode),POINTER :: p
...
!=====================================================================
      ...
      INTEGER(kind=int64),INTENT(IN) :: numSources, numTargets
