  ...
  module rism_report_c
    ...
    interface rism_report_message
       module procedure message, message_i, message_is, message_isi,&
            message_isis,&
            message_isisi, message_isisisi, message_isisisi_int64, &
            message_isrsi, &
    ...
    interface rism_report_error
       module procedure error, error_i, error_ia, error_is, error_isi, &
            error_isisisi, error_isisisi_int64,&
    ...
    interface mwrite
       module procedure mwrite_, mwrite_i, mwrite_ia, mwrite_is, mwrite_isi, mwrite_isis,&
            mwrite_isisi, mwrite_isisisi, mwrite_isisisi_int64,&
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    subroutine message_isisisi_int64(form,string,i1,s2,i2,s3,i3,s4,i4)
      implicit none
      character(len=*), intent(in) :: form, string, s2,s3,s4
      integer(kind=int64), intent(in) :: i1,i2,i3,i4
      call mwrite(munit,form, string,i1,s2,i2,s3,i3,s4,i4)
    end subroutine message_isisisi_int64
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    subroutine mwrite_isisisi_int64(unit,form,string,i1,s2,i2,s3,i3,s4,i4)
      implicit none
      character(len=*), intent(in) :: form, string, s2,s3,s4
      integer(kind=int64), intent(in) :: i1,i2,i3,i4
      integer, intent(in) :: unit
...
#endif /*MPI*/
           write(unit,form) string,i1,s2,i2,s3,i3,s4,i4
    end subroutine mwrite_isisisi_int64
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    subroutine error_isisisi_int64(form,string,i1,s2,i2,s3,i3,s4,i4)
      implicit none
      character(len=*), intent(in) :: form, string, s2, s3, s4
      integer(kind=int64), intent(in) :: i1, i2, i3, i4
      call mwrite_isisisi_int64(eunit,form,"ERROR> "//string,i1,s2,i2,s3,i3,s4,i4)
      call halt()
    end subroutine error_isisisi_int64
