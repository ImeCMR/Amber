...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  subroutine  rlft3i (this, datar, key)
    ...
    integer :: iarray, ir, ix, iy, iz
    integer(kind=int64) :: i, j
    integer(kind=int64) :: nr, nk
    integer :: dim(3)
#  ifdef RISM3D_DEBUG
    integer :: irank, ierr
...
#  endif
  ...
  subroutine  rlft3i (this, datar, key)
    ...
    ! us say so.
    _REAL_, pointer :: datar(:,:)
    integer(kind=int64) :: ngr_total, ngk_total, ig1
    integer :: igx, igy, igz, iv
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  subroutine tonr(this, data, n1, n2, n3)
    ...
    integer :: i, j,k, i1, j1, k1, ispec, ondx, nndx
    integer(kind=int64) :: ngr, ngk
    ngr = n1*n2*n3
    ngk = (n1 + 2)*n2*n3
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  subroutine fromnr(this, data, n1, n2, n3)
    ...
    integer, intent(in) :: n1, n2, n3
    _REAL_, intent(inout) ::  data((n1+2)*n2*n3)
    integer(kind=int64) :: i, j, k, ispec, ondx, nndx
    integer(kind=int64) :: ngr, ngk
    ngr = n1*n2*n3
    ngk = (n1+2)*n2*n3
    data(2:ngr+2*n2*n3:2) = -data(2:ngr+2*n2*n3:2)
