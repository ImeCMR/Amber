...
!    DEL = 1e-4
  ...
  subroutine lennardJonesForce(this, ff, guv, periodic)
    ...
    integer :: igx, igy, igz, igA(3), iu, iv, id, idim1, idim2
    integer(kind=8) :: ig, ig2, igk
...
! by the solvent charge density onto the solute.
  subroutine particleMeshEwaldRecipForce (this,ff,guv)
    ...
    integer(kind=int64) :: igk, igk_fort, ig1, igk_cpp, igk_fort_global, igk_cpp_global
    integer :: id
    integer :: iu, iv
...
! Force errors are larger and not uniform that the Ewald approach.  
  subroutine solventPoissonForce(this, ff, guv)
    ...
    integer :: ix, iy, iz, ixyz
    integer :: igx, igy, igz
    integer(kind=8) :: ig, ig_fort, ig_cpp, igk, igk_fort, igk_cpp
    integer :: id
    integer :: iu, iv
  ...
  subroutine force_brute(this, ff, guv)
    ...
    integer ::  igx, igy, igz, iu, iv, id, idim1, idim2
    integer(kind=8) :: ig, igoffset
