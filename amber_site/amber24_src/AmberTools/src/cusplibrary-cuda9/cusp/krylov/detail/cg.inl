...
//        float x_norm = cusp::blas::nrm1(exec, x); 
//        std::cout << " x_norm:  "  << std::setw(10) << std::scientific << x_norm << std::endl;
/////////////////////////////////////////////
//....... print nrm1 of b tomorrow.......
/////////////////////////////////////////////
...
//    // Newage
//        float r_norm = cusp::blas::nrm1(exec, r); 
//        std::cout << "ruxi r_norm:  "  << std::setw(10) << std::scientific << r_norm << std::endl;
//        exit(2);
//    //if (!monitor.finished(exec, r)) std::cout << "  before while" << std::endl;
    ...
    while (!monitor.finished(exec, r))
    {
        ...
        // Newage
        //ruxi++;
        //std::cout << "itn inside cg: " << ruxi << std::endl;
    }
}
